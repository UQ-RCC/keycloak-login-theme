...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section="form">
            ...
            <form id="kc-reset-password-form" class="login-form js-reset-form" action="${url.loginAction}" method="post">
                    ...
                    <p class="form-reset-description">Enter the username or email address associated with your account and we will send you an email with password reset instructions.</p>
